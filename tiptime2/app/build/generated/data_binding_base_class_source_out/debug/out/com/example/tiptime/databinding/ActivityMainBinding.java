...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ScrollView rootView, @NonNull Button calculateButton,
      ...
      @NonNull TextView tipAmount, @NonNull RadioGroup tipOptions) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tip_amount;
      TextView tipAmount = ViewBindings.findChildViewById(rootView, id);
      if (tipAmount == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ScrollView) rootView, calculateButton, costOfService,
          ...
          serviceQuestion, tipAmount, tipOptions);
    }
